...
;
 insert into detailProduct
    values ('1', '2019-05-07', 'Máy có thiết kế mỏng nhẹ thuộc hàng top trong phân khúc, chỉ 7.9 mm. Mặt lưng với họa tiết cắt kim cương đa sắc nổi bật, đi kèm là 3 tùy chọn màu sắc sành điệu: Xanh Crush Đa Sắc, Trắng Crush Lấp Lánh, Đen Crush Kim Cương.'),
           ('2', '2019-04-07', 'Samsung Galaxy S10 Lite là một phiên bản khác của dòng Galaxy S10 đã ra mắt trước đó nhưng mang trong mình khá nhiều khác biệt về ngoại hình cũng như bên trong.'),
           ('3', '2019-05-20', 'Sau A51, Samsung tiếp tục ra mắt Galaxy A71 là đại diện kế tiếp thuộc thế hệ smartphone Galaxy A 2020. Máy được cải tiến với camera macro siêu cận đột phá, camera chính lên đến 64 MP cùng thiết kế thời thượng và cao cấp.'),
           ('6', '2019-07-21', 'Thừa hưởng những thiết kế đã đạt đến độ chuẩn mực, thế hệ iPhone 8 Plus thay đổi phong cách bóng bẩy hơn và bổ sung hàng loạt tính năng cao cấp cho trải nghiệm sử dụng vô cùng tuyệt vời.'),
           ('7', '2019-11-03', 'Để tìm kiếm một chiếc smartphone có hiệu năng mạnh mẽ và có thể sử dụng mượt mà trong 2-3 năm tới thì không có chiếc máy nào xứng đang hơn chiếc iPhone 11 Pro Max 512GB mới ra mắt trong năm 2019 của Apple.'),
           ('10', '2020-01-15', 'Thừa hưởng những thiết kế đã đạt đến độ chuẩn mực, thế hệ Oppo Reno2 F thay đổi phong cách bóng bẩy hơn và bổ sung hàng loạt tính năng cao cấp cho trải nghiệm sử dụng vô cùng tuyệt vời.'),
           ('11', '2019-09-05', 'Kế thừa phiên bản OPPO A7 đã từng gây hot trước đó, OPPO A9 (2020) có nhiều sự cải tiến hơn về màn hình, camera và hiệu năng trải nghiệm.'),
           ('12', '2020-03-12', 'Tiếp nối thành công vang dội của thế hệ Find X, OPPO chính thức ra mắt Find X2 với những đường nét thanh lịch từ thiết kế phần cứng cho đến trải nghiệm phần mềm, hứa hẹn một vẻ đẹp hoàn hảo, một sức mạnh xứng tầm.'),
           ('14', '2020-04-20', 'Huawei P40 Pro là một trong 3 mẫu smartphone đầu bảng năm 2020 đến từ nhà Huawei. Chiếc máy sở hữu cụm 4 camera Leica chụp ảnh và quay phim đỉnh cao, thiết kế màn hình siêu tràn ấn tượng cùng hiệu năng khủng xứng tầm flagship.'),
           ('15', '2017-05-30', 'Thừa hưởng những thiết kế đã đạt đến độ chuẩn mực, thế hệ Huawei  Nova 5T thay đổi phong cách bóng bẩy hơn và bổ sung hàng loạt tính năng cao cấp cho trải nghiệm sử dụng vô cùng tuyệt vời.'),
           ('18', '2019-12-12', 'Siêu phẩm tầm trung Xiaomi Mi Note 10 Pro, chiếc smartphone đầu tiên sở hữu ống kính độ phân giải 108 MP cùng hệ thống 5 camera độc đáo, công nghệ sạc siêu nhanh 30W đi kèm nhiều tính năng nổi trội khác.'),
           ('19', '2020-05-15', 'Thừa hưởng những thiết kế đã đạt đến độ chuẩn mực, thế hệ Xiaomi Note 10 Pro thay đổi phong cách bóng bẩy hơn và bổ sung hàng loạt tính năng cao cấp cho trải nghiệm sử dụng vô cùng tuyệt vời.'),
           ('23', '2019-05-06', 'Những chiếc smartphone Realme luôn gây được sự chú ý của người dùng bởi những trang bị trên máy so với tầm giá tiền và mới đây "siêu phẩm giá rẻ" Realme 5 3GB/64GB ra mắt lại một lần nữa khiến người dùng không khỏi "trầm trồ".')
;
insert into Color
    values ('1', 'Red', 5),
           ('1', 'Black', 5),
