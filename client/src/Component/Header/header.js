...
class Header extends React.Component {
  ...
  search(event) {
    ...
    if (
      this.refs.txt.value.length !== 0 ||
      this.refs.txt.value !== undefined ||
      this.refs.txt.value !== ""
    ) {
        ...
        <header>
          ...
          <div id="top-header">
            <div className="container">
              <ul
                className="header-links pull-left ml-5"
                style={{ color: "white", marginLeft: "10%" }}
              >
                <li>
                  <i className="fa fa-phone"></i> +012-34-56-78
                </li>
                <li>
                  <i className="fa fa-envelope-o"></i> xwatch@sis.hust.edu.com
                </li>
                <li>
                  <i className="fa fa-map-marker"></i> Số 1 Đại Cồ Việt
                </li>
              </ul>
            </div>
          </div>
                    ...
                    <form className="row">
                      ...
                      <div style={{ minWidth: "250px" }}>
                        <input
                          ...
                          style={{ margin: "auto 0", minWidth: "100%" }}
                        />
                      </div>
                  ...
                  <div className="header-ctn">
                    <Dropdown>
                      <Dropdown.Toggle
                        ...
                        style={{ background: "#15161D", border: "none" }}
                      >
                        <i
                          className="fa fa-shopping-cart mr-2 pr-3"
                          style={{ fontSize: "25px" }}
                        ></i>
                                ...
                                <div className="product-widget" key={key}>
                                  ...
                                  <div className="product-body">
                                    <h3
                                      ...
                                      style={{ fontSize: "13px" }}
                                    >
                                      <Link to={"/product/" + index.idproduct}>
                                        {index.name}
                                      </Link>
                                    </h3>
                                    <h4 className="product-price">
                                      ...
                                      {formatter.format(index.price * 1000)}
                                    </h4>
                                  </div>
                                  <button
                                    className="delete"
                                    onClick={(event) =>
                                      this.delette(event, key)
                                    }
                                  >
                        ...
                        <Dropdown.Item>
                          <div className="cart-summary">
                            <h5 style={{ fontSize: "15px" }}>
                              Tổng: {formatter.format(this.state.total)}
                            </h5>
                          </div>
                        </Dropdown.Item>
                        <Dropdown.Item>
                          ...
                          <div className="cart-btns">
                            <button
                              ...
                              style={{ fontSize: "15px" }}
                              onClick={(event) => this.thanhtoan(event)}
                            >
                              Thanh toán{" "}
