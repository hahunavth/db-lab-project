...
class ProductBox extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={this.props.isNew ? "" : "col-md-6 col-lg-4 col-sm-6 col-12"}
      ...
      >
        <div className="product">
          ...
          <div className="product-body">
            <p className="product-category" style={{ fontSize: "15px" }}>
              {" "}
              Đồng hồ
            </p>
            <h3 className="product-name" style={{ fontSize: "17px" }}>
              <Link to={"/product/" + this.props.id}>{this.props.name}</Link>
            </h3>
            <h4 className="product-price" style={{ fontSize: "18px" }}>
