...
class Product extends React.Component {
  ...
  handleColor = (event) => {
    ...
    if (this.state.Qty[i].quantity == 0) {
      this.setState({
  ...
  handleOrder = async (e) => {
    ...
    if (this.state.color !== null && this.state.Soluong !== null) {
      if (
        ...
        json_str = [];
        var order = {
          IdProduct: this.state.product.idLoaiDongHo,
        ...
        if (json_str.length !== 0) {
          ...
          for (var i = 0; i < json_str.length; i++) {
            ...
            if (
              item.IdProduct === this.state.product.idproduct &&
              item.color === this.state.color
            ) {
              item.quantity =
                parseInt(this.state.Soluong) + parseInt(item.quantity);
          ...
          if (flat === 0) {
            ...
            order = {
              IdProduct: this.state.product.idLoaiDongHo,
              name: this.state.product.ten,
              url: this.state.product.urlAnh,
              color: this.state.color,
              quantity: this.state.Soluong,
              price: this.state.product.giaTien,
            };
            json_str.push(order);
      ...
      .then(
        (result) => {
          ...
          this.setState({
            ...
            url: result.detail?.idLoaiDongHo,
            Qty: result.detail?.so_luong,
            currentImage: result.detail?.urlAnh,
            specification: result.detail?.moTa,
            color: result.detail?.chongNuoc,
            qty: result.detail?.so_luong,
          });
              ...
              <div className="col-md-5 col-lg-5">
                <div className="product-details">
                  <h2 className="product-name">
                    {this.state.product?.ten ||
                      "Database error, not found product"}
                  </h2>
                  <div>
                  ...
                  <div>
                    <h3 className="product-price">
                      {" "}
                      {formatter.format(
                        (this.state.product?.giaTien || 0) * 1000
                      )}{" "}
                    </h3>
                  </div>
                  <p></p>
                  ...
                  >
                    <div className="add-to-cart ">
                      ...
                      <button
                        className={
                          this.state.errFormQty !== "" || this.state.qty == 0
                            ? "cant add-to-cart-btn"
                            : "add-to-cart-btn"
                        }
                        disabled={this.state.errFormQty !== "" ? true : false}
                      >
                              ...
                              <tbody>
                                ...
                                <tr className="techSpecRow">
                                  ...
                                  <td className="techSpecTD2">
                                    {this.state.product.chatLieuDay}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">Chất liệu mặt</td>
                                  <td className="techSpecTD2">
                                    {this.state.product.chatLieuMat}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">Chất liệu vỏ</td>
                                  <td className="techSpecTD2">
                                    {" "}
                                    {this.state.product.chatLieuVo}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">
                                  ...
                                  <td className="techSpecTD2">
                                    {" "}
                                    {this.state.product.duongKinhMat}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">Chống nước</td>
                                  <td className="techSpecTD2">
                                    {this.state.product.chongNuoc}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">Giới tính </td>
                                  <td className="techSpecTD2">
                                    {this.state.product.gioiTinh}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">
                                  ...
                                  <td className="techSpecTD2">
                                    {this.state.product.nangLuongSuDung}
                                  </td>
                                </tr>
                                <tr className="techSpecRow">
                                  <td className="techSpecTD1">Ngày sản xuất</td>
                                  <td className="techSpecTD2">
                                    {moment(this.state.product.ngayTao).format(
                                      "DD/MM/YYYY"
                                    )}
                                  </td>
                                </tr>
